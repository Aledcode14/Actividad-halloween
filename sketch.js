...
function options(){
  ...
  parche.position(windowWidth/2+210,windowHeight/10);
  parche.size(50,50);
  ...
  textSize(22);
  fill("white");
  text("Selecciona una figura para decorar",windowWidth/3,windowHeight/7);
...
function editor(){
  ...
  myPicker.position(windowWidth/2+210,windowHeight/10);
  myPicker.size(50,50);
